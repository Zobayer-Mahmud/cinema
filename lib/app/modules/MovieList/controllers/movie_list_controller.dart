...
import 'package:cinema/app/base/base_controller.dart';import 'package:cinema/app/data/response/movie/movie_list_response.dart';
...
class MovieListController extends BaseController {
  ...
  void routeToNearbyTheaters() {
    Get.toNamed(Routes.NEARBY_THEATER);
  }
}
